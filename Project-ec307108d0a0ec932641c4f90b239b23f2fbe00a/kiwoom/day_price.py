...
class Kiwoom(QAxWidget):
    def __init__(self):
        ...
        # 로깅용 설정파일
        logging.config.fileConfig('C:/Users/quantec/Desktop/kiwoom/logging.conf')
    ...
    def get_data_opt10081(self, code, date='20200918'):
        ...
        #self.data_opt10081.to_csv(r'C:/Users/quantec/Desktop/kiwoom/ohlcv/opt10081_' + code + '.csv', encoding='euc-kr', index=False)
        diff = self.data_opt10081[['일자', '현재가']]
        diff['SYMBOL'] = code
        diff['일자'] = diff['일자'].astype(int)
        diff.reset_index(drop=True, inplace=True)
        diff['일자'] = diff['일자'].astype('str')

        szsql = """SELECT TRADE_DATE, CODE, ADJUST_PRICE FROM TC1101HS WHERE CODE = %s AND TRADE_DATE >= 20180703 ORDER BY TRADE_DATE DESC"""
        curs.execute(szsql, str(code))
        result = curs.fetchall()
        sym70 = pd.DataFrame(result)
        sym70.columns = ['일자', 'SYMBOL', 'DB']

        df = pd.merge(diff, sym70, on=['일자', 'SYMBOL'], how='outer')
        df.drop_duplicates(inplace=True)
        df = df[(df['현재가'] != df['DB'])]
        try:
            df.dropna(inplace=True)
            if len(df) > 1:
                sd.Beep(3000, 3000)  # winsound.Beep(frequency, duration)
                df.to_csv(r'C:/Users/quantec/Desktop/kiwoom/ohlcv/error_' + code + '.csv', encoding='euc-kr',
                          index=False)
            else:
                print('same')
                pass
    ...
    def get_data_opt10086(self, code, date):
        ...
        self.data_opt10086['종가'] = abs(self.data_opt10086['종가'])
        self.data_opt10086.to_csv(r'C:/Users/quantec/Desktop/kiwoom/ohlcv/069500_1.csv', encoding='euc-kr', index=False)



        #self.data_opt10086.to_csv(r'C:/Users/quantec/Desktop/kiwoom/ohlcv/test'+code+'.csv', encoding='euc-kr', index=False)
...
if __name__ == "__main__":
    ...
    # db 에서 국내 종목 데이터를 받아온다.
    szsql = """SELECT DISTINCT(CODE) FROM TC1101HS"""
    curs.execute(szsql)
    result = curs.fetchall()
    sym70 = pd.DataFrame(result)
    sym70.columns = ['SYMBOL']
    kr_symbol = sym70['SYMBOL'].unique().tolist()

    #10081 TR#
    #kr_symbol = ['002070','005110','027740','036830','039670','065560','069500','080720','083660','090850','095270','102110','105330','139220','139240','139260','139290','140950','148020','152100','152870','170350','182480','192410','192720','210780','211560','215090','217790','220100','227830','228820','230360','245350','251370','261140','266140','266160','269370','277630','277640','289250','291210','292100','292110','292150','292160','293180','299170','304760','307750','322410','322780','323230','329200','335890','900110','900140']
    for kr in kr_symbol:
        data = kiwoom.get_data_opt10081(kr, "20200918")
        print(len(data))
    '''
    #10086 TR#
    for kr in kr_symbol:
        #data = kiwoom.get_data_opt10086(kr, today)
        data = kiwoom.get_data_opt10086(kr, "20200911")
        print(len(data))
    '''
